...
BUILTIN_PRESETS = {
    'JP TikTok Comedy': dict(language='Japanese', voice='jf_alpha', speed=1.03, gap_ms=100,
    ...
    'US Reviewer': dict(language='English US', voice='am_puck', speed=1.03, gap_ms=100,
        adaptive=True, loudness=True, overflow='Safe Trim', emotion_mode='Manual',
        emotion='Funny / Playful', intensity='Medium', effect='None', strength='Medium',
        native_style=None, continuous=True, continuous_target_ms=100),
    'Renovation Calm': dict(language='English US', voice='af_heart', speed=1.0, gap_ms=100,
        adaptive=True, loudness=True, overflow='Safe Trim', emotion_mode='Manual',
        emotion='Calm', intensity='Mild', effect='None', strength='Medium',
        native_style=None, continuous=True, continuous_target_ms=110),
    'Horror Narration': dict(language='English US', voice='am_onyx', speed=1.0, gap_ms=100,
        adaptive=True, loudness=True, overflow='Safe Trim', emotion_mode='Manual',
        emotion='Narrator', intensity='Medium', effect='None', strength='Medium',
        native_style=None, continuous=True, continuous_target_ms=110),
    'Food Challenge': dict(language='English US', voice='am_puck', speed=1.05, gap_ms=100,
        adaptive=True, loudness=True, overflow='Safe Trim', emotion_mode='Manual',
