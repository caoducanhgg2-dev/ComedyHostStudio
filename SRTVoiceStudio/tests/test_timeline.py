...
def test_adaptive_timeline_reuses_existing_100ms_gap_without_overlap():
    ...
    slots = slots_for(c)
    # Original END leaves 100 ms. Adaptive mode may use most of that silence,
    # while retaining a tiny 30 ms guard before the next immutable START.
...
def test_adaptive_timeline_can_extend_past_original_end_but_never_next_start():
